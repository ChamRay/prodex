 ...
 * @description: bcd编解码器
 */
public class BcdParser implements CodexParser, Coding {
    @Override
    ...
    @Override
    public byte[] encode(byte[] bytes, Object o, CodexEnum type) {
        return new byte[0];
    }

    @Override
    public Object decode(byte[] bytes, CodexEnum type) {
        return null;
    }
}
